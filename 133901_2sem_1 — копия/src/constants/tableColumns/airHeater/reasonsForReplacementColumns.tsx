import ModalEditReplacementReason from '@/components/modals/airHeater/ModalEditReplacementReason';
...
export default () => {
  const { handleDelete } = useModel('useReplacementReasonsModel');
